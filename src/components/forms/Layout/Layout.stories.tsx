...
export const defaultLayout = (): React.ReactElement => (
  <Layout>
    ...
    <FormGroup
      name="EAF form"
      legend="Enabling Accessibility Fund (EAF) - Small Projects Component"
    >
      ...
      <MultipleChoice
        ...
        id="2"
      />
      <SectionHeader>Organization Identification</SectionHeader>
      ...
      <SectionHeader>Secondary Contact</SectionHeader>
      ...
      <SectionHeader>Organization Contacts</SectionHeader>
      ...
      <FormGroup
        ...
        legend="Project Proposal Description"
      >
        <TextArea
        ...
        <TextArea
          label="If yes, in about 250 words, provide an explanation and any details on the actions and communication activities you will take to meet that community’s needs"
          description="In 500 words or less, describe the need of the proposed project including what it aims to achieve (objective and anticipated results), and who is the targeted group."
          id="39"
          name="project-objectives"
        />
